...
%Tema2: Mini Proiect2
%Executat: Stoica Mihail 422D

P=40; %perioada
D=20; %numarul din lista cu studnenti ;
...
%calculati, reprezinta , cum observam si in formula, o suma sinusi, si daca
%marim numarul de coeficienti N, aproiem si semnalul recunstruit de forma
%sa ideala (triunghi, dreptunghi, etc.) , iar daca micsoram numarulde coef.
